    ...
    return (
      <>
        {value ? (
         ...
         : (<li data-notification-type={type} dangerouslySetInnerHTML={html} onClick={() => console.log(id)} className={css(type === 'default' ? style.default : style.urgent, style.small)}></li>)}
      </>
    );
  };
}
